...
namespace H163_ext_test
{
    ...
    public static class offsets
    {
        ...
        public static readonly int Anchored = 0x1A5;
        ...
        public static readonly int CameraMaxZoomDistance = 0x300;
        public static readonly int CameraMinZoomDistance = 0x304;
        public static readonly int CameraMode = 0x308;
        ...
        public static readonly int CanCollide = 0x1A5;
        public static readonly int CanCollideMask = 0x8;
        public static readonly int CanTouch = 0x1A5;
        public static readonly int CanTouchMask = 0x10;
        public static readonly int CharacterAppearanceId = 0x2A8;
        ...
        public static readonly int DataModelDeleterPointer = 0x7FA1990;
        ...
        public static readonly int FFlagList = 0x7A96EB8;
        public static readonly int FFlagToValueGetSet = 0x30;
        public static readonly int FOV = 0x160;
        public static readonly int FakeDataModelPointer = 0x7FA1988;
        ...
        public static readonly int FramePositionOffsetX = 0x52C;
        public static readonly int FramePositionOffsetY = 0x534;
        public static readonly int FramePositionX = 0x528;
        public static readonly int FramePositionY = 0x530;
        public static readonly int FrameRotation = 0x188;
        public static readonly int FrameSizeOffsetX = 0x550;
        public static readonly int FrameSizeOffsetY = 0x554;
        public static readonly int FrameSizeX = 0x548;
        public static readonly int FrameSizeY = 0x54C;
        public static readonly int FrameVisible = 0x5C1;
        ...
        public static readonly int HealthDisplayDistance = 0x328;
        ...
        public static readonly int JobsPointer = 0x8058020;
        ...
        public static readonly int ModelInstance = 0x370;
        ...
        public static readonly int MouseSensitivity = 0x8001970;
        public static readonly int MoveDirection = 0x158;
        public static readonly int Name = 0xB0;
        public static readonly int NameDisplayDistance = 0x334;
        ...
        public static readonly int PlayerConfigurerPointer = 0x7F7FCE8;
        public static readonly int PlayerMouse = 0xCE8;
        ...
        public static readonly int ScreenGuiEnabled = 0x654;
        ...
        public static readonly int TaskSchedulerPointer = 0x8057E48;
        public static readonly int Team = 0x280;
        public static readonly int TeamColor = 0xD0;
        public static readonly int TextLabelText = 0xAC8;
        public static readonly int TextLabelVisible = 0x5C1;
        ...
        public static readonly int VisualEnginePointer = 0x7A7F950;
