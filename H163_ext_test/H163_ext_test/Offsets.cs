...
{
    public static readonly int DebugDisableTimeoutDisconnect = 0x682cf18;
    public static readonly int EnableLoadModule = 0x68227d8;
    public static readonly int PartyPlayerInactivityTimeoutInSeconds = 0x67eaa4c;
    public static readonly int PhysicsSenderMaxBandwidthBps = 0x67eaef4;
    public static readonly int PhysicsSenderMaxBandwidthBpsScaling = 0x67eaf00;
    public static readonly int TaskSchedulerTargetFps = 0x7542f70;
    public static readonly int WebSocketServiceEnableClientCreation = 0x6839c00;
    public static readonly int WorldStepMax = 0x67ee7f8;
    public static readonly int WorldStepsOffsetAdjustRate = 0x67ee7f4;
}
...
public static class MouseService
{
    ...
    public static readonly int SensitivityPointer = 0x806f770;
}
...
public static class PlayerConfigurer
{
    ...
    public static readonly int Pointer = 0x7fed958;
}
...
{
    public static readonly int Value = 0x45ee;
}
...
public static class TaskScheduler
{
    ...
    public static readonly int Pointer = 0x80a5ac8;
