    ...
    public static class AnimationTrack
{
    ...
    public static readonly int IsPlaying = 0x518;
...
public static class BasePart
{
    ...
    public static readonly int Material = 0x248;
...
{
    public static readonly int DebugDisableTimeoutDisconnect = 0x67c3730;
    public static readonly int EnableLoadModule = 0x67b90e8;
    public static readonly int PartyPlayerInactivityTimeoutInSeconds = 0x6781a70;
    public static readonly int TaskSchedulerTargetFps = 0x74d5644;
    public static readonly int WebSocketServiceEnableClientCreation = 0x67d04c8;
}

public static class FakeDataModel
{
    public static readonly int Pointer = 0x7fa1988;
...
public static class GuiObject
{
    ...
    public static readonly int Image = 0xa10;
    public static readonly int LayoutOrder = 0x594;
    public static readonly int Position = 0x528;
    public static readonly int RichText = 0xac8;
    public static readonly int Rotation = 0x188;
    public static readonly int ScreenGui_Enabled = 0x4dc;
...
{
    public static readonly int InputObject = 0x0;
    public static readonly int MousePosition = 0x0;
    public static readonly int SensitivityPointer = 0x8001970;
}
...
public static class Player
{
    ...
    public static readonly int Gender = 0xe78;
    public static readonly int LocalPlayer = 0x130;
    public static readonly int MaxZoomDistance = 0x300;
    public static readonly int MinZoomDistance = 0x304;
    public static readonly int ModelInstance = 0x370;
    public static readonly int Mouse = 0xce8;
...
{
    public static readonly int OverrideDuration = 0x5894805;
    public static readonly int Pointer = 0x7f7fce8;
}
...
{
    public static readonly int HeartbeatFPS = 0xb8;
...
{
    public static readonly int Value = 0xc8;
}
...
public static class TaskScheduler
{
    ...
    public static readonly int Pointer = 0x8057e48;
...
public static class Workspace
{
    ...
    public static readonly int ReadOnlyGravity = 0x9b8;
}
