...
public static class Offsets3
{
    public static readonly int AbsolutePositionX = 0x110,
         ...
         FakeDataModelPointer = 0x8010838,
         FakeDataModelToRealDataModel = 0x1C0,
         FogColor = 0xFC,
         FogEnd = 0x134,
         FogStart = 0x138,
         ForceNewAFKDurationPointer = 0x67EAA4C,
         ...
         PlatformName = 0xEE0,
         PlatformStand = 0x1DF,
         PlayerConfigurerPointer = 0x7FED958,
         PlayerMouse = 0xD10,
         PrimaryPart = 0x278,
         Primitive = 0x148,
         ...
         SunTextureId = 0x230,
         TaskSchedulerPointer = 0x80A5AC8,
         TaskSchedulerTargetFps = 0x7542F70,
         Team = 0x290,
         TeamColor = 0xD0,
         TextColor3 = 0xEB8,
         TextLabelText = 0xE08,
         ...
         VoiceChatRollOffMaxDistance = 0x67EE6FC,
         VoiceChatRollOffMinDistance = 0x67EE6F8,
         Walkspeed = 0x1D4,
